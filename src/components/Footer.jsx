...
export default function Footer() {
  return (
    <footer
      ...
      style={{
        marginTop: '100px',
        backgroundColor: 'rgba(204, 204, 255, 0.08)',
        padding: '60px 20px',
        borderTop: '1px solid rgba(204, 204, 255, 0.25)'
      }}
    >
      <div
        className="container"
      ...
      >
        <div style={{ maxWidth: '300px' }}>
          <h3 style={{ fontSize: '24px', color: 'var(--accent-terracotta)', marginBottom: '15px' }}>Trailing Dreams</h3>
          <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }}>
            Curated botanical collections for the modern plant lover. We bring the outdoors in.
          </p>
        </div>
        <div style={{ display: 'flex', gap: '60px' }}>
          <div>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <li><Link to="/shop" style={{ color: 'var(--text-secondary)' }}>Shop All</Link></li>
              <li><Link to="/care" style={{ color: 'var(--text-secondary)' }}>Care Guide</Link></li>
