...
export default function ProductDetails() {
  ...
  return (
    <main style={{ padding: '140px 20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }} className="product-details-layout">
        <div style={{ borderRadius: '32px', overflow: 'hidden', boxShadow: '0 20px 50px rgba(255, 155, 134, 0.1)' }}>
          <img src={plant.img} alt={plant.title} style={{ width: '100%', height: 'auto', display: 'block' }} />
        </div>
        <div>
