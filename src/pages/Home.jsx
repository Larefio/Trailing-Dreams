    ...
    <main>
      <section className="hero" style={{ background: "linear-gradient(rgba(255, 250, 246, 0.3), rgba(255, 250, 246, 0.8)), url('img/sala-jardin.jpg') center/cover no-repeat" }}>
        <div className="container">
          ...
          <p style={{ color: 'var(--text-secondary)', fontWeight: 'bold' }}>We connect your home with nature. Specialists in unique species, exotic plants, and tools for their daily care.</p>
          <Link to="/shop" className="btn" style={{ background: 'var(--accent-terracotta)', color: '#fff', padding: '15px 30px', borderRadius: '40px', fontWeight: 'bold' }}>Explore Shop</Link>
        </div>
      </section>
