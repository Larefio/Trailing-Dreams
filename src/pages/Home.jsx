  ...
  return (
    <main>
      <section
        className="hero"
        style={{
          background: `linear-gradient(rgba(74, 74, 122, 0.55), rgba(74, 74, 122, 0.75)), url('${base}img/sala-jardin.jpg') center/cover no-repeat`
        }}
      >
        <div className="container">
          <h1 style={{ color: '#ffffff' }}>Welcome to Trailing Dreams</h1>
          <p style={{ color: 'rgba(255,255,255,0.9)', fontWeight: 'bold' }}>
            We connect your home with nature. Specialists in unique species, exotic plants, and tools for their daily care.
          </p>
          <Link
            to="/shop"
            className="btn"
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '30px' }}>
          ...
          <Link to="/shop" style={{ display: 'block', borderRadius: '30px', overflow: 'hidden', position: 'relative', height: '300px' }}>
            <div
              style={{
                ...
                background: `url('${base}img/Darlingtonia.jpg') center/cover no-repeat`,
          ...
          <Link to="/shop" style={{ display: 'block', borderRadius: '30px', overflow: 'hidden', position: 'relative', height: '300px' }}>
            <div
              style={{
                position: 'absolute', top: 0, left: 0, right: 0, bottom: 0,
                background: `url('${base}img/hoya-carnosa.jpg') center/cover no-repeat`,
                transition: 'transform 0.5s ease'
              }}
              className="cat-bg"
            />
          ...
          <Link to="/shop" style={{ display: 'block', borderRadius: '30px', overflow: 'hidden', position: 'relative', height: '300px' }}>
            <div
              style={{
                position: 'absolute', top: 0, left: 0, right: 0, bottom: 0,
                background: `url('${base}img/Euphorbia-tirucalli.jpg') center/cover no-repeat`,
                transition: 'transform 0.5s ease'
              }}
              className="cat-bg"
            />
