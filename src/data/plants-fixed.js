...
const rawPlants = [
  ...
  // TOOLS & CARE
  { id: 'jard-1', title: 'BEST MILEGA Potting Fertilizers Vermicompost', price: 12.99, category: 'jardineria', imgFile: 'https://images.unsplash.com/photo-1585633857640-1033e660ee2e?w=500&h=500&fit=crop', description: 'High quality organic vermicompost potting fertilizer for lush, healthy plant growth.' },
  { id: 'jard-2', title: 'Ugaoo Organic Potting Garden Soil Mix 5Kg', price: 14.99, category: 'jardineria', imgFile: 'https://images.unsplash.com/photo-1599383679800-474c6d66e7b5?w=500&h=500&fit=crop', description: 'Ready-to-use organic blend with nutrient-rich red soil and cow manure. Perfect for indoor and outdoor plants.' },
  { id: 'jard-3', title: 'Expert Gardener Bone Meal Plant Food 3-15-0, 4 lb', price: 7.98, category: 'jardineria', imgFile: 'https://images.unsplash.com/photo-1591857177580-dc82b9ac4e1e?w=500&h=500&fit=crop', description: 'Expert Gardener Bone Meal is an excellent source of phosphorus and calcium. Great for bulbs and root development.' },
  { id: 'jard-4', title: 'Expert Gardener All Purpose Plant Food 16-16-16, 20 lb', price: 18.98, category: 'jardineria', imgFile: 'https://images.unsplash.com/photo-1628155930542-3c7a64e2c833?w=500&h=500&fit=crop', description: 'All-purpose 16-16-16 formula. Provides essential nutrients for vibrant flowers and productive vegetable gardens.' },
