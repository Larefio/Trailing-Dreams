...
const rawPlants = [
  ...
  { id: 'herr-1001462915', title: 'Professional Circular Saw 220V 1500W', price: 288.99, category: 'herramientas', imgFile: 'https://promart.vteximg.com.br/arquivos/ids/10735484/imageUrl_1.jpg?v=639148249241470000', description: 'Features: 1,500 W motor mounted on ball bearings for longer life and better performance in heavy duty tasks.' },
  { id: 'herr-1001462464', title: 'Bosch Pro Pruner Cordless Shears + Battery/Charger', price: 959.9, category: 'herramientas', imgFile: 'https://promart.vteximg.com.br/arquivos/ids/10732636/imageUrl_1.jpg?v=639147242221370000', description: 'Product: Cordless pruning shears perfect for effortless and precise cutting of thick branches.' },
  { id: 'herr-1001462243', title: 'Bosch Pro Pruner Brushless Cordless Shears', price: 639.9, category: 'herramientas', imgFile: 'https://promart.vteximg.com.br/arquivos/ids/10731831/imageUrl_1.jpg?v=639147241988930000', description: 'Product: Bosch Pro Pruner Brushless. Features: Fast results and smooth cuts for professional landscaping.' },
  { id: 'herr-1001460971', title: 'Truper 12067 Orange 6-Drawer Mobile Metal Cabinet', price: 1619.99, category: 'herramientas', imgFile: 'https://promart.vteximg.com.br/arquivos/ids/10725351/imageUrl_1.jpg?v=639144793264270000', description: 'Features 6 spacious drawers with ball-bearing slides that guarantee a smooth and durable glide.' },
  { id: 'herr-1001460594', title: 'Truper 12172 Replacement Blade 3cm x 1.9cm', price: 21.99, category: 'herramientas', imgFile: 'https://promart.vteximg.com.br/arquivos/ids/10724325/imageUrl_1.jpg?v=639144649808570000', description: 'Truper 12172 Replacement Blade. Sharp and durable, perfect for utility knives and precise cutting tasks.' },
  { id: 'herr-1001455837', title: 'Ingco Industrial 40W Soldering Iron Pencil', price: 47.99, category: 'herramientas', imgFile: 'https://promart.vteximg.com.br/arquivos/ids/10698754/imageUrl_1.jpg?v=639135579359130000', description: 'TECHNICAL DATA: Voltage: 220-240V ~ 50/60Hz, Input power: 40W. Ideal for small electrical repairs.' }
];
